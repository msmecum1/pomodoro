...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 365514655, ; hash 0x15c94f9f, from name: libaot-Pomodoro.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 655331801, ; hash 0x270f91d9, from name: Pomodoro
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 66
	...
	%struct.DSOCacheEntry {
		i64 2916770634, ; hash 0xadda634a, from name: libaot-Pomodoro
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 329
	...
	%struct.DSOCacheEntry {
		i64 3048678602, ; hash 0xb5b724ca, from name: Pomodoro.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 348
	...
	%struct.DSOCacheEntry {
		i64 3523044437, ; hash 0xd1fd6455, from name: aot-Pomodoro
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 395
	...
	%struct.DSOCacheEntry {
		i64 3888681324, ; hash 0xe7c8916c, from name: aot-Pomodoro.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 432
