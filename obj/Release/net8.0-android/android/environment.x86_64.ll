...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 96470299718765794, ; hash 0x156bb39fa1ccce2, from name: libaot-Pomodoro.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10583940034238790097, ; hash 0x92e1b56290d6b9d1, from name: aot-Pomodoro
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 264
	...
	%struct.DSOCacheEntry {
		i64 13533734328495794461, ; hash 0xbbd17baabe80691d, from name: aot-Pomodoro.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 349
	...
	%struct.DSOCacheEntry {
		i64 14079752962286927377, ; hash 0xc36554b8b25dbe11, from name: Pomodoro.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 368
	...
	%struct.DSOCacheEntry {
		i64 15536866428099424200, ; hash 0xd79e09b2d18eefc8, from name: libaot-Pomodoro
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 406
	...
	%struct.DSOCacheEntry {
		i64 17685457929988968255, ; hash 0xf56f5e49271b8f3f, from name: Pomodoro
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Pomodoro.dll.so
		ptr null; void* handle (0x0)
	}, ; 455
...
@.env.3 = private unnamed_addr constant [37 x i8] c"536e334f-e78e-497b-8e62-59ffc8d9ad20\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.pomodoro\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [23 x i8] c"libaot-Pomodoro.dll.so\00", align 16
